  ...
  return (
    <>
      <div className=" relative bg-[var(--warm-sand)] m-10 justify-items-center ">
        <div className=" relative z-1 w-130 tracking-widest leading-8 h-screen text-justify md:w-150 ">
          <div className="my-10">
            <span className="text-[var(--soft-purple)] text-4xl font-bold md:text-5xl">
              Our Story
            </span>
          </div>
          <p className='text-gray-800/60 text-2xl md:text-3xl'>
          ...
          <div className="my-10">
            <span className="text-[var(--mint-green)] text-4xl font-bold md:text-5xl">
              Our Mission
            </span>
          </div> 
          <p className='text-gray-800/60 text-2xl md:text-3xl'>
